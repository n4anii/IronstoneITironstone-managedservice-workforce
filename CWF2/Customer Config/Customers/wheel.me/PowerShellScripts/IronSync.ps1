...
$StorageAccountName = [string]$('ironsyncwheelme')
$StorageAccountSASToken = [string]$('?sv=2021-06-08&ss=f&srt=sco&sp=rl&se=2032-06-23T19:36:50Z&st=2022-06-23T11:36:50Z&spr=https&sig=lvPDGD4BcfaagTAVgIIfPNC1KceTEFHLIKSAhLTNvHY%3D')
