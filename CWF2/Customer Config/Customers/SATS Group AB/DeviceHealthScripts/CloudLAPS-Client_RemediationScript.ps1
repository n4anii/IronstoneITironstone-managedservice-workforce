...
Process {
    ...
    $LocalAdministratorName = "LokalAdmin"

    # Construct the required URI for the Azure Function URL
    $URI = "https://satscloudlapsfunctionapp.azurewebsites.net/api/SetSecret?code=RNsjkWEnxRe65GXI5akLotvN908ByM83yvGcLZDYJpO4YtV1uJZRIA=="
