#**************************** Part to fill ************************************
# Log analytics part
$CustomerId = "915741a3-640a-43f0-820d-10c8f1259f6a" # Log Analytics Workspace ID
$SharedKey = 'P6btz/eMr+5N+yicKorq0v2AztI2vql0b65wijvbSXEHcZ4NGHzP0bU5az3x3raoy9HTm/1sQqcerqMMN049fA==' # Log Analytics Workspace Primary Key
...
$Authorized_Accounts = @(
"S-1-12-1-1563182469-1119853951-1863970719-1549028908 S-1-12-1-1302646777-1309699780-3538235533-2613571229";
"Administrator";
