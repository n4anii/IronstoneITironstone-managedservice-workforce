...
### Settings - Share
$ShareLetter             = [string]$('Q') # Change to desired driveletter (don't use double colon : )
$SharePath               = [string]$('\\afs.bergans.local\MediaLibrary') # Change to desired server / share path
$ShortCutTitle           = [string]$('MediaLibrary') #this will be the name of the shortcut
