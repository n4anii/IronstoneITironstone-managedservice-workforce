...
### Settings - Share
$ShareLetter             = [string]$('F') # Change to desired driveletter (don't use double colon : )
$SharePath               = [string]$('\\afs.bergans.local\felles') # Change to desired server / share path
$ShortCutTitle           = [string]$('Felles') #this will be the name of the shortcut
