...
application="Microsoft Teams.app"
logdir="/Library/Ironstone/log"
log="/Library/Ironstone/log/installTeams.log"
...
echo ""
echo "##############################################################"
echo "# $(date) | Checking if application exists. "
echo "############################################################"
echo ""

if [ -d $application ]; then

	echo "$(date) | Application already exists, exiting script"
	exit 0
else
	echo "$(date) | Application doesn't exist, jumping to installation"
fi
