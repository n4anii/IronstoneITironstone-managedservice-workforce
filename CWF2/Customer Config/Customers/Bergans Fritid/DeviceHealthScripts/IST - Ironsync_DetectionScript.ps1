...
$StorageAccountName = [string]$('bergansclientstorage')
$StorageAccountSASToken = [string]$('?sv=2021-06-08&ss=f&srt=sco&sp=rl&se=2032-10-07T20:04:17Z&st=2022-10-07T12:04:17Z&spr=https&sig=TzSNV%2FrtBrIwI%2FCcU8VVJpBOFak8OfNTUkB%2FGtZDPfE%3D')
