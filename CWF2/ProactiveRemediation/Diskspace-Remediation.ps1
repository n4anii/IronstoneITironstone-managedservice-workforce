...
if ($freespace -le 0.60) {
    ...
    & 'cmd' '/c' 'cleanmgr.exe /verylowdisk /q'
}
...
<toast scenario="info">
    <visual>
        <binding template="ToastGeneric">
            ...
            <group>
                <subgroup>
                    <text hint-style="body" hint-wrap="true">After automatically trying to free diskspace you are still low on disc space</text>
                </subgroup>
            </group>
            <group>
                <subgroup>
                    <text hint-style="body" hint-wrap="true">This might affect performance and stability of your PC</text>
                </subgroup>
            </group>
        </binding>
    </visual>
    <actions>
        <action activationType="protocol" arguments="https://support.ironstoneit.com" content="Get support" />
