...
#>
    ...
    $user = whoami
    $DisplayNAme = Get-WMIObject Win32_UserAccount | where caption -eq $user | select -ExpandProperty FullName
    #Set companyname
    $CompanyName = 'https://ironstoneit.com'
    #Set header
    $Header = 'Manu LOooooooST'
    ...
    #Save hero image to temp folder
    $Base64HeroImage_Path = "$env:TEMP\Base64HeroImage.png"
    # Convert ServiceUI from Base64 to EXE
    [byte[]]$Bytes = [convert]::FromBase64String($Base64HeroImage)
    [System.IO.File]::WriteAllBytes($Base64HeroImage_Path, $Bytes)
...
<toast scenario="info">
    <visual>
        <binding template="ToastGeneric">
            <image placement="hero" src="file:///$Base64HeroImage_Path" />
            ...
            <text>Good evening $DisplayNAme</text>
            <group>
                <subgroup>
            ...
            <group>
                <subgroup>
                    <text hint-style="body" hint-wrap="true">As you know, MANU Lost.</text>
                </subgroup>
            </group>
            <group>
                <subgroup>
                    <text hint-style="body" hint-wrap="true">Loverpool won... </text>
                </subgroup>
            </group>
            <group>
                <subgroup>
                    <text hint-style="body" hint-wrap="true">Will Solskjær survive? Maybe you should restart</text>
                </subgroup>
            </group>
        </binding>
    </visual>
    <actions>
        <action activationType="protocol" arguments="ToastReboot:" content="Restart now" />
        <action activationType="protocol" arguments="https://ironstoneit.com" content="Learn More" />
