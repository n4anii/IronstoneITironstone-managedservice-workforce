...
.DESCRIPTION
Set's the current users Culture to NB-NO, if the current culture is English.  There's a small check that will make sure the script is only run on new computers. 
