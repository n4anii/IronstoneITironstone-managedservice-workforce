    ...
    elseif ($Script:VolumeEncryptionStatus -eq $Script:BitLockerVolumeEncryptionStatuses[0]) {
        ...
        if ($Script:VolumeHasTPMandPW -and $Script:VolumeHasTPMandPW[0]) {
            ...
            try {
                ...
                $null = Enable-BitLocker -MountPoint $OSDrive -TpmProtector -UsedSpaceOnly:$false -HardwareEncryption:$false -ErrorAction 'Continue'
                if ($?) {
                ...
                LogErrors
                Enable-BitLocker -MountPoint $OSDrive -TpmProtector -UsedSpaceOnly:$false -HardwareEncryption:$false -ErrorAction 'SilentlyContinue'
