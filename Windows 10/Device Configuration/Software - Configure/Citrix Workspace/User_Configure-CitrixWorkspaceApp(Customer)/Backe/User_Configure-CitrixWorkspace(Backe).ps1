<#
    .SYNOPSIS
    Configures Citrix Workspace App. Will work with both .EXE installer, and UWP from Microsoft Store.
...
[string] $NameScript    = 'Configure-CitrixWorkspace(Backe)'
...
################################################
    ...
    #region Main
        ...
        if (Test-RegistryValue -PathToCheck $CheckRegPath -ValueToCompare $CheckRegValue) {
            ...
            # Path to temporary registry file
            ...
            # Output new registry file from Base64 string
