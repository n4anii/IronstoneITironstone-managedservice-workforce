...
## Changelog
### v201116
#### Install-IronSync.ps1
* Added support for devices with multiple users.
	* Removed everything that has to do with setting registry values in user context, will create a extension like Teams Backgrounds for this.



### v201008
#### Install-IronSync.ps1
* Fixed goof in updated Intune script template.
