...
### Settings - Share
$ShareLetter             = [string]$('H') # Change to desired driveletter (don't use double colon : )
$SharePath               = [string]$('\\bwfs003\Home') # Change to desired server / share path
$ShortCutTitle           = [string]$('Koble til ``Hjem´´') #this will be the name of the shortcut
