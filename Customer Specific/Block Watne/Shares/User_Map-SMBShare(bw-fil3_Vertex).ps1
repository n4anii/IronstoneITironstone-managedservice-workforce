...
### Settings - Share
$ShareLetter             = [string]$('X') # Change to desired driveletter (don't use double colon : )
$SharePath               = [string]$('\\bw-fil3\vertex') # Change to desired server / share path
$ShortCutTitle           = [string]$('Koble til ``Vertex´´') #this will be the name of the shortcut
