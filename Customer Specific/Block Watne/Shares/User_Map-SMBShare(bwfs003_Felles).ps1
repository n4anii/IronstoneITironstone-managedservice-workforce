...
$SharePath               = [string]$('\\bwfs003\common avdelinger$') # Change to desired server / share path
$ShortCutTitle           = [string]$('Koble til ``Felles´´') #this will be the name of the shortcut
