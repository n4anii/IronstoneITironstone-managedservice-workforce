...
### Settings - Share
$ShareLetter             = [string]$('G') # Change to desired driveletter (don't use double colon : )
$SharePath               = [string]$('\\bwfs003\Globalfelles') # Change to desired server / share path
$ShortCutTitle           = [string]$('Koble til ``Global felles´´') #this will be the name of the shortcut
