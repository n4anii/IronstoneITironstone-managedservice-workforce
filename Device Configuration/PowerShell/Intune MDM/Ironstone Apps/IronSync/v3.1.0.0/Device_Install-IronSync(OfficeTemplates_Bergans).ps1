...
$CustomerAzureStorageAccountName     = [string]$('bergansclientstorage')
$CustomerAzureStorageAccountBlobName = [string]$('office365-templates')
$CustomerAzureStorageAccountSASToken = [string]$('?sv=2019-12-12&ss=b&srt=co&sp=rlx&se=2022-08-18T17:11:05Z&st=2020-08-17T22:38:05Z&spr=https&sig=gWB%2FXKtqLuqlHPs48Zpa82%2FzqyI1RIxyn6F8gnTp%2FLo%3D')
