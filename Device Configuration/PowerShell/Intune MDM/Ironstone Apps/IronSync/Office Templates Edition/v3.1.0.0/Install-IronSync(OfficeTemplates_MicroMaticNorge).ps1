...
# Customer Assets
$CustomerName                        = [string]$('MicroMaticNorge')
$CustomerAzureStorageAccountName     = [string]$('mmnsacs01')
$CustomerAzureStorageAccountBlobName = [string]$('office-templates')
$CustomerAzureStorageAccountSASToken = [string]$('?sv=2018-03-28&ss=b&srt=co&sp=rl&se=2030-03-11T22:29:21Z&st=2019-03-11T14:29:21Z&spr=https&sig=2KG71uzSwuiljlHxtiiqIBPuik79hrxJtN3OIMxyuEI%3D')
