...
# Customer Assets
$CustomerName                        = [string]$('INSR')
$CustomerAzureStorageAccountName     = [string]$('insrclientstorage')
$CustomerAzureStorageAccountBlobName = [string]$('office365-templates')
$CustomerAzureStorageAccountSASToken = [string]$('?sv=2019-02-02&ss=b&srt=co&sp=rl&se=2022-01-30T11:49:18Z&st=2020-01-30T11:49:18Z&spr=https&sig=cpYBaTZe5x9xQ31QRWIP8L9FpEw0uYdQZM%2BmsTaKF%2B8%3D')
