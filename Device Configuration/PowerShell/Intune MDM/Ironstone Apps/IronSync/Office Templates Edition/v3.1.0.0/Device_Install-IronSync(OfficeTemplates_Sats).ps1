...
# Customer Assets
$CustomerName                        = [string]$('Sats')
$CustomerAzureStorageAccountName     = [string]$('satso365templatessa01')
$CustomerAzureStorageAccountBlobName = [string]$('office365-templates')
$CustomerAzureStorageAccountSASToken = [string]$('?sv=2018-03-28&ss=b&srt=co&sp=rdl&se=2029-04-05T16:05:30Z&st=2019-04-04T08:05:30Z&spr=https&sig=f6cMHmnIInweAiWQyxweNHj4ji45Q1aZotQN6gGhdv8%3D')
