...
# Customer Assets
$CustomerName                        = [string]$('BlockWatne')
$CustomerAzureStorageAccountName     = [string]$('cid01peuwbptwo365stg')
$CustomerAzureStorageAccountBlobName = [string]$('office-templates')
$CustomerAzureStorageAccountSASToken = [string]$('?sv=2019-02-02&ss=b&srt=co&sp=rl&se=2030-11-11T12:00:00Z&st=2019-11-11T12:00:00Z&spr=https&sig=ITFe7S1QtiL8qTdnpGPfUrwx4o%2B%2FpWg8n0IYNWDOWkk%3D')
