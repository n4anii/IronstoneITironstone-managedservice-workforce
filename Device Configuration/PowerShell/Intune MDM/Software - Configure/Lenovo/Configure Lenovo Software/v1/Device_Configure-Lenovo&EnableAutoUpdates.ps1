...
Configure-Lenovo&EnableAutoUpdates
...
[string] $NameScript    = 'Configure-Lenovo&EnableAutoUpdates'
...
if ((Get-ItemProperty -Path 'HKLM:\HARDWARE\DESCRIPTION\System\BIOS' -Name 'SystemManufacturer' | Select-Object -ExpandProperty 'SystemManufacturer') -notlike 'lenovo') {
    ...
    #region    Action & Variables
        # Variables HKLM      
            ...
            [string] $PathDirRegImControllerSystemUpdate = ('{0}\Plugins\LenovoSystemUpdatePlugin' -f ($PathDirRegImController))     #'HKLM:\SOFTWARE\WOW6432Node\Policies\Lenovo\ImController\Plugins\LenovoSystemUpdatePlugin'
