...
.SYNOPSIS
    Configures Lenovo ImController, System Update, Vantage and WiFi Security, and Enables auto updates. Runs once.
...
[string] $NameScript    = 'Configure-Lenovo&EnableAutoUpdates(RunOnce)'
