...
.SYNOPSIS
    Installs a PowerShell script that runs every three hour to make sure Lenovo Software is properly configured, and that Lenovo Auto Updates are disabled.
...
[string] $NameScript    = 'Install-LenovoConfig(DisableUpdates)'
...
[string] $NameFilePS1ToInstall = 'Configure-Lenovo&DisableAutoUpdates.ps1'
