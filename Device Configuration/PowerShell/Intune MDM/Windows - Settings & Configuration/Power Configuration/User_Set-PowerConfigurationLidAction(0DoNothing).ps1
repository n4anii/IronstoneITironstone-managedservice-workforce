...
# Script Variables
$NameScript            = [string] 'Set-PowerConfigurationLidAction(0DoNothing)'
$DeviceContext         = [bool]   $false
$WriteToHKCUFromSystem = [bool]   $false

# Script Settings
$LidAction             = [byte]   0     # 0 = Do nothing, 1 = Sleep, 2 = Hibernate, 3 = Shut down
...
################################################
    ...
    # Register Path to check whether it has been ran previously
    $RegistryPath = [string]$('Registry::HKEY_CURRENT_USER\SOFTWARE\IronstoneIT\Intune\DeviceConfiguration\UserSetPowerConfigurationLidAction')
    ...
    if (Test-Path -Path $RegistryPath) {
        ...
        $Arguments = [string[]]$(
            # On Power
            [string]$('/setacvalueindex SCHEME_CURRENT 4f971e89-eebd-4455-a8de-9e59040e7347 5ca83367-6e45-459f-a27b-476b1d01c936 {0}' -f ($LidAction)),
            # On Battery
            [string]$('/setdcvalueindex SCHEME_CURRENT 4f971e89-eebd-4455-a8de-9e59040e7347 5ca83367-6e45-459f-a27b-476b1d01c936 {0}' -f ($LidAction)),
            # Set SCHEME_CURRENT to be active
            [string]$('/setactive SCHEME_CURRENT')
        )
