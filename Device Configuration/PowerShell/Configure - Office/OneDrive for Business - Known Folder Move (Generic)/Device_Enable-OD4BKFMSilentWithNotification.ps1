<#
Device_Enable-OD4BKFMSilentWithNotification.ps1

.SYNAPSIS
Will enable OneDrive for Business Known Folder Move. Silent config with notifications.
...
[string] $NameScript    = 'Enable-OD4BKFMSilentWithNotification'
...
#region    Assets
    ...
    [PSCustomObject[]] $RegValues = @(
        ...
        [PSCustomObject]@{Path=[string]$PathDirReg;Name=[string]'KFMSilentOptInWithNotification';Value=[byte]1;          Type=[string]'DWord'}
    )
